      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div variants={fadeIn("right", "tween", 0.2, 1)}>
            <div className="bg-slate-50 p-5 sm:p-8 rounded-xl shadow-md">
              <h3 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">Contact Us</h3>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Your SaaS Company" {...field} className="text-sm sm:text-base" />
                        </FormControl>
                        <FormMessage className="text-xs sm:text-sm" />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm sm:text-base">Annual Recurring Revenue</FormLabel>
                        <Select 
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="<100k" className="text-sm sm:text-base">Less than $100K</SelectItem>
                            <SelectItem value="100k-500k" className="text-sm sm:text-base">$100K - $500K</SelectItem>
                            <SelectItem value="500k-1m" className="text-sm sm:text-base">$500K - $1M</SelectItem>
                            <SelectItem value="1m-5m" className="text-sm sm:text-base">$1M - $5M</SelectItem>
                            <SelectItem value=">5m" className="text-sm sm:text-base">More than $5M</SelectItem>
                          </SelectContent>
                        </Select>
                        <FormMessage className="text-xs sm:text-sm" />
                      </FormItem>
          ...
          <motion.div variants={fadeIn("left", "tween", 0.2, 1)}>
            <div className="bg-slate-800 p-5 sm:p-8 rounded-xl shadow-md text-white mb-6 sm:mb-8">
              <h3 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">Acquisition Criteria</h3>
                ...
                <li className="flex items-start space-x-2 sm:space-x-3">
                  <div className="flex-shrink-0 mt-1">
                    <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-emerald-500 flex items-center justify-center">
                      <i className="fas fa-check text-white text-[0.6rem] sm:text-xs"></i>
                    </div>
                  </div>
            ...
            <div className="bg-slate-50 p-5 sm:p-8 rounded-xl shadow-md">
              <h3 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">Frequently Asked Questions</h3>
              <div className="space-y-4 sm:space-y-6 text-sm sm:text-base">
                <div>
                  <h4 className="text-base sm:text-lg font-medium text-slate-800 mb-1 sm:mb-2">What types of businesses do you acquire?</h4>
                ...
                <div>
                  <h4 className="text-base sm:text-lg font-medium text-slate-800 mb-1 sm:mb-2">What's your typical acquisition process?</h4>
                ...
                <div>
                  <h4 className="text-base sm:text-lg font-medium text-slate-800 mb-1 sm:mb-2">How does the AI transformation work?</h4>
                ...
                <div>
                  <h4 className="text-base sm:text-lg font-medium text-slate-800 mb-1 sm:mb-2">What happens to the existing team?</h4>
